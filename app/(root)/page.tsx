...
import { getFiles, getTotalFilesUsed } from '@/lib/actions/file.actions'
  ...
  return (
    <div className='dashboard-container'>
            ...
            <Link href={summary.url} key={summary.title} className='dashboard-summary-card'>
              <div className='space-y-4'>
                <div className='flex justify-between gap-3'>
                  <Image src={summary.icon} alt='uploaded image' width={100} height={100} className='summary-type-icon' />
      ...
      <section className='dashboard-recent-files'>
          <h2 className='h3 xl:h2 text-light-100'>Recent File Uploaded</h2>
          {
