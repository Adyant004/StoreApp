...
import { deleteFiles, renameFiles, updateFileUsers } from "@/lib/actions/file.actions";
import { usePathname } from "next/navigation";
import { ActionDetails, ShareInput } from "./ActionsModalContent";
  ...
  const renderDialogContent = () => {
    ...
    const handleAction = async () => {
        ...
        const actions = {
            ...
            delete: () => deleteFiles({fileId: file.$id,path,bucketFileId: file.bucketFileId}),
        };
